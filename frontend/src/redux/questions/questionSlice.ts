...
export const loadQuestions = createAsyncThunk<Question[]>(
...
export const loadAskerQuestions = createAsyncThunk<Question[], number>(
  "question/loadAskerQuestions",
  async (id, thunkAPI) => {
    try {
      const res: Response = await fetch(
        `${process.env.REACT_APP_PUBLIC_URL}/question/user/${id}`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" },
        }
...
export const loadAnswererQuestions = createAsyncThunk<Question[], number>(
  "question/loadAnswererQuestions",
  async (id, thunkAPI) => {
    try {
      const res: Response = await fetch(
        `${process.env.REACT_APP_PUBLIC_URL}/question/answerer/${id}`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" },
        }
...
export const loadQuestion = createAsyncThunk<Question, number>(
  "question/loadQuestion",
  async (id, thunkAPI) => {
    try {
      const res: Response = await fetch(
        `${process.env.REACT_APP_PUBLIC_URL}/question/${id}`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" },
        }
...
export const createQuestion = createAsyncThunk<Question, Object>(
...
=======
      const res: Response = await fetch(
        `${process.env.REACT_APP_PUBLIC_URL}/question`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(data),
>>>>>>> 4d3d051a81ff9b0534000dcdce8cdffb69424a7d
      ...
      const followerRes = await fetch(
        `${process.env.REACT_APP_PUBLIC_URL}/user/followers/${userData.id}`
      );
      const followerJson = await followerRes.json();
...
export const deleteQuestion = createAsyncThunk<
  Question,
  { question_id: number; user_id: number }
>("question/deleteQuestion", async (data, thunkAPI) => {
  try {
    const res: Response = await fetch(
      `${process.env.REACT_APP_PUBLIC_URL}/question/${data.question_id}`,
      {
        method: "DELETE",
        headers: { "Content-Type": "application/json" },
      }
...
>("question/createAnswer", async (data, thunkAPI) => {
  try {
...
>("question/deleteAnswer", async (data, thunkAPI) => {
  try {
    const res: Response = await fetch(
      `${process.env.REACT_APP_PUBLIC_URL}/answer/${data.answer_id}`,
      {
        method: "DELETE",
        headers: { "Content-Type": "application/json" },
      }
