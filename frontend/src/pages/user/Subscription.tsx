...
import { loadFollowings, loadFollowingsId, loadFollowers } from "../../redux/subscription/subscriptionSlice";
        ...
        <IonPage>
            ...
            <IonContent>
                <Container>
                    ...
                    <IonSearchbar value={keyword} placeholder="搜索用戶" onIonChange={handleKeywordChange}></IonSearchbar>
                    
                    {segment === 'follower' ? <Follower keyword={keyword}/> : <Following keyword={keyword}/>}
                </Container>
            </IonContent>
        </IonPage>
    )
